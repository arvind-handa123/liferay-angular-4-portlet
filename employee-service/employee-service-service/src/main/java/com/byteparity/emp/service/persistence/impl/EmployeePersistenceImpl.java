...
package com.byteparity.emp.service.persistence.impl;

import aQute.bnd.annotation.ProviderType;

import com.byteparity.emp.exception.NoSuchEmployeeException;
import com.byteparity.emp.model.Employee;
import com.byteparity.emp.model.impl.EmployeeImpl;
import com.byteparity.emp.model.impl.EmployeeModelImpl;
import com.byteparity.emp.service.persistence.EmployeePersistence;
 ...
 * @see com.byteparity.emp.service.persistence.EmployeeUtil
 * @generated
 */
@ProviderType
public class EmployeePersistenceImpl extends BasePersistenceImpl<Employee>
	 ...
	 */
	@Override
	public Employee[] findByUuid_PrevAndNext(long empId, String uuid,
		OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {
	 ...
	 */
	@Override
	public Employee[] findByUuid_C_PrevAndNext(long empId, String uuid,
	...
	protected Employee toUnwrappedModel(Employee employee) {
		...
		employeeImpl.setDob(employee.getDob());
		employeeImpl.setContactNumber(employee.getContactNumber());
		employeeImpl.setOrganization(employee.getOrganization());
